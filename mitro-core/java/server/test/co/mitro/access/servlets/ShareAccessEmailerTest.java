...
public class ShareAccessEmailerTest extends MemoryDBFixture {

  private ShareAccessEmailer emailer;
  private MockHttpServletRequest request;
  private MockHttpServletResponse response;

  @Before
  public void setup() {
    emailer = new ShareAccessEmailer(managerFactory, null);
  ...
  public void noParameters() throws Exception {
    ...
    assertEquals("{\"errorMessage\":\"Please enter valid email addresses\"}", response.getOutput());
  }
